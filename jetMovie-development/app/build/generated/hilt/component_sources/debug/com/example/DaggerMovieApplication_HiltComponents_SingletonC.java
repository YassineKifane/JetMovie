...
import com.example.jetmovie.di.FirebaseModule;
import com.example.jetmovie.di.FirebaseModule_ProvideFirebaseAuthFactory;
...
import com.example.jetmovie.ui.account.AccountViewModel;
import com.example.jetmovie.ui.account.AccountViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMovieApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MovieApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return ImmutableSet.<String>of(AccountViewModel_HiltModules_KeyModule_ProvideFactory.provide(), DetailViewModel_HiltModules_KeyModule_ProvideFactory.provide(), HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends MovieApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>of("com.example.jetmovie.ui.account.AccountViewModel", ((Provider) accountViewModelProvider), "com.example.jetmovie.ui.detail.DetailViewModel", ((Provider) detailViewModelProvider), "com.example.jetmovie.ui.home.HomeViewModel", ((Provider) homeViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.jetmovie.ui.account.AccountViewModel 
          return (T) new AccountViewModel(singletonCImpl.provideFirebaseAuthProvider.get());

          case 1: // com.example.jetmovie.ui.detail.DetailViewModel 
          return (T) new DetailViewModel(singletonCImpl.provideMovieDetailRepositoryProvider.get());

          case 2: // com.example.jetmovie.ui.home.HomeViewModel 
  ...
  private static final class SingletonCImpl extends MovieApplication_HiltComponents.SingletonC {
    ...
    private void initialize() {
      ...
      this.provideMovieDetailApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<MovieDetailApiService>(singletonCImpl, 2));
      this.provideMovieMapperProvider = DoubleCheck.provider(new SwitchingProvider<ApiMapper<MovieDetail, MovieDetailDto>>(singletonCImpl, 3));
      this.provideMovieMapperProvider2 = DoubleCheck.provider(new SwitchingProvider<ApiMapper<List<Movie>, MovieDto>>(singletonCImpl, 4));
      this.provideMovieDetailRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MovieDetailRepository>(singletonCImpl, 1));
      this.provideMovieApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<MovieApiService>(singletonCImpl, 6));
      this.provideMovieRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MovieRepository>(singletonCImpl, 5));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.example.jetmovie.movie_detail.domain.repository.MovieDetailRepository 
          ...
          case 2: // com.example.jetmovie.movie_detail.data.remote.api.MovieDetailApiService 
          return (T) MovieDetailModule_ProvideMovieDetailApiServiceFactory.provideMovieDetailApiService();

          case 3: // com.example.jetmovie.common.data.ApiMapper<com.example.jetmovie.movie_detail.domain.models.MovieDetail,com.example.jetmovie.movie_detail.data.remote.models.MovieDetailDto> 
          return (T) MovieDetailModule_ProvideMovieMapperFactory.provideMovieMapper();

          case 4: // com.example.jetmovie.common.data.ApiMapper<java.util.List<com.example.jetmovie.movie.domain.models.Movie>,com.example.jetmovie.movie.data.remote.models.MovieDto> 
          return (T) MovieModule_ProvideMovieMapperFactory.provideMovieMapper();

          case 5: // com.example.jetmovie.movie.domain.repository.MovieRepository 
          ...
          case 6: // com.example.jetmovie.movie.data.remote.api.MovieApiService 
